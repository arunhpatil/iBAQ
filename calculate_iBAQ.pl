...
print OUT "Gene Symbol\tNumber of trptic peptides\tNumber of PSMs\tsummed Intensities\tiBAQ\tlog(iBAQ,2)\tNSAF\n";

open (TRY, "Preparatory/pre_gene_tryptic_iBAQ_NSAF_RS89_gene.txt") or die $!;
while (<FILE>)
{
	chomp ($_);
	$_ =~ s/\r//g;
